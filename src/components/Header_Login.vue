<template>
  <header
    class="flex flex-col sm:flex-row justify-between items-center bg-transparent max-h-[100px] gap-4 py-4"
  >
    <img
      class="max-sm:w-32 sm:w-40 lg:w-50 max-h-[150px] max-sm:hidden"
      src="../assets/logo.png"
      alt=""
    />
    <div
