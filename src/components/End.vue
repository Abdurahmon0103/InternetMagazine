<template>
  <section
    class="max-sm:grid max-sm:grid-cols-2 flex lg:flex-row justify-between pt-5 pb-10 gap-8 lg:gap-4"
  >
    <div class="text-center lg:text-left">
      <p class="font-bold pb-4 lg:pb-7 text-lg">Biz haqqimizda</p>
      <p class="text-sm sm:text-base">Topshirish punktlari</p>
      <p class="text-sm sm:text-base">Vakansiyalar</p>
    </div>
    <div class="text-center lg:text-left">
      <p class="font-bold pb-4 lg:pb-7 text-lg">Foydalanuvchilarga</p>
      <p class="text-sm sm:text-base">Biz bilan bog'lanish</p>
      <p class="text-sm sm:text-base">Savol-Javob</p>
    </div>
    <div class="text-center lg:text-left">
      <p class="font-bold pb-4 lg:pb-7 text-lg">Tadbirkorlarga</p>
      <p class="text-sm sm:text-base">Uzumda soting</p>
      <p class="text-sm sm:text-base">Sotuvchi kabinetiga kirish</p>
      <p class="text-sm sm:text-base">Topshirish punktini ochish</p>
    </div>
    <div class="text-center lg:text-left">
      <div>
        <p class="font-bold text-lg">Ilovani yuklab olish</p>
        <div
        ...
        >
          <div class="flex items-center gap-2">
            ...
            <p class="text-sm sm:text-base">App store</p>
          </div>
          <div class="flex items-center gap-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <p class="text-sm sm:text-base">Google play</p>
          </div>
        </div>
      </div>
    </div>
    <div
      class="max-sm:w-screen max-sm:pr-8 max-sm:flex max-sm:flex-col max-sm:justify-center max-sm:items-center"
    >
      <p class="font-bold pb-3 text-lg">Olma ijtimoiy tarmoqlarda</p>
